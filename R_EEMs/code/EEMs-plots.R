...
ggsave(paste0(p_outname, dd, "p_wq.png"), p_wq, w = 8, h = 10)
...
p_abs_flor <- (p_m_sd_SUVA / p_m_sd_FI / p_m_sd_HIX / p_m_sd_BA / p_m_sd_S275to295) + plot_layout(guides = "collect") & theme(legend.position = "bottom")
